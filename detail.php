...
input[type="file"] {
  ...
  <div class="contact">
    <form name="submit-to-google-sheet"  action="info.php" method="post" enctype="multipart/form-data">
      ...
      <input type="number" id="mobileNumber" name="mobileNumber" placeholder="Mobile Number" required maxlength="10">
      ...
      <input type="text" id="medicines" name="medicines" placeholder="medicines Name" required>
